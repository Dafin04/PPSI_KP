        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-100">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900">Input Nilai Lapangan</h3>
                    <p class="text-sm text-gray-500">Isi nilai mahasiswa di lapangan.</p>
                </div>

                <div class="p-6">
                    <form method="POST" action="{{ route('lapangan.nilai.store') }}" class="space-y-6">
                        @csrf
